    ...
    <div class="col-md-10" bis_skin_checked="1">
      <div
        ...
        <div class="dt-buttons" bis_skin_checked="1">
          <a class="dt-button add-new btn btn-primary" href="{{ route('sys-user-create') }}"><span> <i
                class="bx bx-plus me-0 me-sm-1"></i>
              <span class="d-none d-sm-inline-block">Novo</span>
            </span>
          </a>
        </div>
      </div>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="{{ route('sys-user-update', $row->id) }}"><i
                          class="bx bx-edit-alt me-1"></i> Editar</a>

                      <form method="POST" action="{{ route('sys-user-delete', $row->id) }}"
                        id="userDelete{{ $row->id }}" display="none">
                        @csrf @method('DELETE')
                      </form>
                      <button type="submit" class="dropdown-item"
                        wire:click="removeRegister('/sys/users', {{ $row->id }})"><i class="bx bx-trash me-1"></i>
                        Remover</button>
                    </div>
                  </div>
                </td>
