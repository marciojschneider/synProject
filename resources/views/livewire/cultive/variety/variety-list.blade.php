    ...
    <div class="col-md-10" bis_skin_checked="1">
      <div
        ...
        <div class="dt-buttons" bis_skin_checked="1">
          <a class="dt-button add-new btn btn-primary" href="{{ route('cultive-variety-create') }}"><span> <i
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="{{ route('cultive-variety-update', $row->id) }}"><i
                          class="bx bx-edit-alt me-1"></i> Editar</a>

                      <form method="POST" action="{{ route('cultive-variety-delete', $row->id) }}"
                        id="varietyDelete{{ $row->id }}" display="none">
                        @csrf @method('DELETE')
                      </form>
                      <button type="submit" class="dropdown-item"
                        wire:click="removeRegister('/cultive/varieties', {{ $row->id }})"><i
