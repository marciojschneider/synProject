<div class="col-md">
  <h4 class="mb-4">
    <span class="text-muted fw-light">Estrutura / Fazenda /</span> Cadastrar
  </h4>
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form wire:submit.prevent="submit">
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-2">
            <label for="module" class="form-label">Propriedade</label>
          ...
          <div class="col-md-3">
            <label for="module" class="form-label">Proprietário</label>
